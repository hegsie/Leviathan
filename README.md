...
A: Yes! Leviathan builds are Apple Silicon (ARM64) only for now — Metal GPU acceleration for AI features works out of the box. There is no Intel or universal build yet; see [ROADMAP.md](ROADMAP.md#open-work).
